...
<div class="card p-4">
  ...
  <form action="/dashboard/peminjaman/insert" method="POST">
    <div class="d-flex flex-column gap-3">
        ...
        <div class="input-group input-group-static">
          ...
          <select class="form-control" name="buku_id">
            ...
            <?php foreach ($buku as $item) : ?>
              <option value="<?= $item['id'] ?>"><?= $item['judul'] ?> - <?= $item['pengarang'] ?></option>
            <?php endforeach; ?>
          </select>
        </div>
      </div>
      <div class="d-flex flex-column gap-3">
        <div class="input-group input-group-outline">
          ...
          <input type="date" class="form-control" name="tanggal_dipinjam" value="<?= date('Y-m-d') ?>">
        </div>
        <div class="input-group input-group-static">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control border" name="keterangan" id="keterangan" rows="5"></textarea>
        </div>
      </div>
      <div class="d-flex flex-row gap-3">
